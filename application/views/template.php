...
<head>
    ...
    <title>Surat | Kelurahan Sungai Ulin</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('Home') ?>">Surat | Kelurahan Sungai Ulin
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        ';
                        } else if ($this->session->userdata('nama_jabatan') == 'Sekretaris') {
                            echo '
                        <li>
                            <a href="' . base_url('home') . '"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
